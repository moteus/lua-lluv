...
-- Helper function to proceed start/stop download and close application
local on_begin, on_end, cleanup do

on_begin = function(easy, url, num)
...
on_end = function(easy, err, url)
  easy.data.file:close()
  easy.data.file = nil
...
-- Create and dispatch tasks beetween easy handles
-- Use preallocated cache of cURL easy handles
